...
public class OI {
    ...
    public JoystickButton extendo;
    public JoystickButton retracto;
    ...
    public OI() {
        ...
        retracto = new JoystickButton(gamePad, 10);
        retracto.whenPressed(new RetractClimber());
        extendo = new JoystickButton(gamePad, 9);
        extendo.whenPressed(new ExtendClimber());
