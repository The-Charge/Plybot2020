...
public class OI {
    ...
    public JoystickButton intakePosBtn;
    public JoystickButton intakeNegBtn;
    ...
    public OI() {
        ...
        shiftLowBtn = new JoystickButton(leftJoystick, 4);
        shiftLowBtn.whenPressed(new ShiftLow());
        shiftHighBtn = new JoystickButton(leftJoystick, 3);
        shiftHighBtn.whenPressed(new ShiftHigh());
        rightJoystick = new Joystick(0);
        
        shootBtn = new JoystickButton(rightJoystick, 4);
        shootBtn.whenPressed(new Shoot(0));
        lineBtn = new JoystickButton(rightJoystick, 6);
        lineBtn.whenPressed(new DriveToLine(0));
        gamePad = new Joystick(4);
        
        intakeNegBtn = new JoystickButton(gamePad, 8);
        intakeNegBtn.whileHeld(new RunIntake(-0.5));
        intakePosBtn = new JoystickButton(gamePad, 7);
        intakePosBtn.whileHeld(new RunIntake(0.5));
        ...
        SmartDashboard.putData("Shoot: speed", new Shoot(0.75));
