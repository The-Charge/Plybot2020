...
public class OI {
    ...
    public JoystickButton extentBtn;
    public JoystickButton extentBackBtn;
    ...
    public OI() {
        ...
        extentBackBtn = new JoystickButton(gamePad, 4);
        extentBackBtn.whenPressed(new ComeBackExtent());
        extentBtn = new JoystickButton(gamePad, 3);
        extentBtn.whenPressed(new Extent());
        ...
        SmartDashboard.putData("Extent", new Extent());
        SmartDashboard.putData("ComeBackExtent", new ComeBackExtent());
