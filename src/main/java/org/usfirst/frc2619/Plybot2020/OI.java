...
public class OI {
    ...
    public JoystickButton shootingBtn;
    ...
    public OI() {
        ...
        shootingBtn = new JoystickButton(gamePad, 1);
        shootingBtn.whileHeld(new Shoot(0));
        shiftLowButton = new JoystickButton(gamePad, 1);
        shiftLowButton.whileHeld(new ShiftHighLow(false));
        shiftHighButton = new JoystickButton(gamePad, 1);
        shiftHighButton.whileHeld(new ShiftHighLow(false));
        ...
        SmartDashboard.putData("DriveToLane: speed", new DriveToLane(1));
        SmartDashboard.putData("Extend", new Extend());
        SmartDashboard.putData("Retract", new Retract());
        SmartDashboard.putData("SPControl", new SPControl());
        SmartDashboard.putData("Shift", new Shift());
        SmartDashboard.putData("ShiftHighLow", new ShiftHighLow());
