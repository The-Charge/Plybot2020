...
public class OI {
    ...
    public JoystickButton intakePositive;
    public JoystickButton intakeNegative;
    ...
    public OI() {
        ...
        shiftlow = new JoystickButton(gamePad, 1);
        shiftlow.whileHeld(new ShiftLow(0));
        shifthigh = new JoystickButton(gamePad, 1);
        shifthigh.whileHeld(new ShiftHigh(0));
        intakeNegative = new JoystickButton(gamePad, 6);
        intakeNegative.whileHeld(new IntakeNegativeC());
        intakePositive = new JoystickButton(gamePad, 5);
        intakePositive.whileHeld(new IntakePositiveC(0));
        ...
        SmartDashboard.putData("HatchOut", new HatchOut());
        SmartDashboard.putData("IntakeNegativeC: speed", new IntakeNegativeC(0));
        SmartDashboard.putData("IntakePositiveC: speed", new IntakePositiveC(.5));
        SmartDashboard.putData("ShiftHigh", new ShiftHigh());
        SmartDashboard.putData("ShiftLow", new ShiftLow());
        SmartDashboard.putData("ShooterC: speed", new ShooterC(1));
