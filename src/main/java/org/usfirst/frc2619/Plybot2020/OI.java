...
public class OI {
    ...
    public OI() {
        ...
        shootBtn = new JoystickButton(gamePad, 9);
        shootBtn.whileHeld(new Shoot(0));
        shiftHigh = new JoystickButton(gamePad, 8);
        shiftHigh.whenPressed(new Shift(true));
        shiftLow = new JoystickButton(gamePad, 7);
        shiftLow.whenPressed(new Shift(false));
        intakeNegative = new JoystickButton(gamePad, 6);
        intakeNegative.whileHeld(new CallSpeedMode(-1));
        intakePositive = new JoystickButton(gamePad, 5);
        intakePositive.whileHeld(new CallSpeedMode(1));
        ...
        SmartDashboard.putData("CallSpeedMode", new CallSpeedMode());
