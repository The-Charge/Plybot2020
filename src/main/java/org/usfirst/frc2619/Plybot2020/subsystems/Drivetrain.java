...
public class Drivetrain extends Subsystem {
    ...
    private static final int MAX_TRICKS_PER_SECOND=6500;
    ...
    public void setPercentSpeedPID(double setSpeed){
        ...
        leftFrontMotor.set(ControlMode.Velocity, MAX_TRICKS_PER_SECOND*setSpeed);
        rightFrontMotor.set(ControlMode.Velocity, MAX_TRICKS_PER_SECOND*setSpeed);
    }
    ...
    public void setPercentSpeedPID(double setSpeedL, double setSpeedR){
        ...
        leftFrontMotor.set(ControlMode.Velocity, MAX_TRICKS_PER_SECOND*setSpeedL);
        rightFrontMotor.set(ControlMode.Velocity, MAX_TRICKS_PER_SECOND*setSpeedR);
    }

    public void writeIndivPIDs(double output1, double outputr){
        leftFrontMotor.pidWrite(output1);
