...
public class Drivetrain extends Subsystem {
    ...
    private static final int TIMEOUT_MS = 20;       //Maximum processing time threshold
    private static final int MAX_TICKS_PER_SPEED = 6500;
    ...
    public void setPercentSpeedPID(double setSpeed)
    {
        ...
        leftFrontMotor.set(ControlMode.Velocity, MAX_TICKS_PER_SPEED * setSpeed);
        rightFrontMotor.set(ControlMode.Velocity, MAX_TICKS_PER_SPEED * setSpeed);
    }
    ...
    public void setPercentSpeedPID(double setSpeedL, double setSpeedR)
    {
        ...
        leftFrontMotor.set(ControlMode.Velocity, MAX_TICKS_PER_SPEED * setSpeedL);
        rightFrontMotor.set(ControlMode.Velocity, MAX_TICKS_PER_SPEED * setSpeedR);
    }

    //Set motors as variables from controllers
