...
public class LightSensors extends Subsystem {
    ...
    private DigitalInput digitalInput5;
    ...
    public LightSensors() {
        ...
        addChild("Digital Input 2",digitalInput2);
        
        
        digitalInput3 = new DigitalInput(2);
        addChild("Digital Input 3",digitalInput3);
        
        
        digitalInput4 = new DigitalInput(3);
        addChild("Digital Input 4",digitalInput4);
        
        
        digitalInput5 = new DigitalInput(4);
        addChild("Digital Input 5",digitalInput5);
